...
{
	public class AntlionClubProjectile : ModProjectile
	{
	...
	public class CheekCrusherProjectile : ModProjectile
	{
		public override string Texture 
			=> TrelamiumTwo.HeaviesAssets + "CheekCrusher";
		private enum AIState
		{
			Spawning,
			Swinging = 2
		...
		private float RotationStart 
			=> MathHelper.PiOver2 + (projectile.direction == -1 ? MathHelper.Pi : 0);
		private float RotationOffset 
			=> projectile.direction == 1 ? 0 : MathHelper.PiOver2;
			...
			if (IsMaxCharge && Main.myPlayer == projectile.owner)
			{
				for (int i = 0; i < 2; ++i)
				{
					Projectile.NewProjectile(projectile.Center, -Vector2.UnitY.RotatedByRandom(MathHelper.PiOver2) * 4f,
						ModContent.ProjectileType<Ranged.NutProjectile>(), (int)(projectile.damage * 0.5f), 0.5f, projectile.owner);
				}
			}
			Utilities.DustUtils.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 78, 60);
		}
		public override void Kill(int timeLeft)
		{
			Main.PlaySound(SoundID.DD2_MonkStaffGroundImpact, -1, -1);
			Utilities.DustUtils.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 78, 50);
		}
	...
	public class CrustaceanClobbererProjectile : ModProjectile
	{
	...
	public class HeavensGaloreProjectile : ModProjectile
	{
	...
	public class TheLaceratorProjectile : ModProjectile
	{
	...
	public class MycelialWarhammerProjectile : ModProjectile
	{
