...
namespace TrelamiumTwo.Content.Projectiles.Melee
{
	public class CheekCrusherProjectile : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			DustHelpers.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 78, 60);
		}
		public override void Kill(int timeLeft)
		{
			Main.PlaySound(SoundID.DD2_MonkStaffGroundImpact, -1, -1);
			DustHelpers.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 78, 50);
		}
