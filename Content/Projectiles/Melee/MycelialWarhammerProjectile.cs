...
namespace TrelamiumTwo.Content.Projectiles.Melee
{
	public class MycelialWarhammerProjectile : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			DustHelpers.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 0, 60);
		}
		public override void Kill(int timeLeft)
		{
			...
			DustHelpers.SpawnDustCloud(projectile.position, projectile.width, projectile.height, 0, 50);
		}
