		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.ai[0] != 1)
			{
				...
				if (projectile.owner == Main.myPlayer)
				{
					...
					vector22 *= 3;
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector22.X, vector22.Y, ProjectileType<SandBallProjectile>(), projectile.damage, projectile.knockBack, projectile.owner, 1f, 0f);
				}
			}
		}
