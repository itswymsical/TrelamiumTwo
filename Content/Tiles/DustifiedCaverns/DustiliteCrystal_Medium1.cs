...
namespace TrelamiumTwo.Content.Tiles.DustifiedCaverns
{
	...
	internal sealed class DustiliteCrystal_Medium1_Item : ModItem
	{
		public override string Texture => "TrelamiumTwo/Content/Tiles/DustifiedCaverns/DustiliteCrystal_Medium1";
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<DustiliteCrystal_Medium1>();
		}
	}
}
