...
namespace TrelamiumTwo.Content.Tiles.DustifiedCaverns
{
	...
	internal sealed class DustiliteCrystal_Medium3_Item : ModItem
	{
		public override string Texture => "TrelamiumTwo/Content/Tiles/DustifiedCaverns/DustiliteCrystal_Medium3";
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<DustiliteCrystal_Medium3>();
		}
	}
}
