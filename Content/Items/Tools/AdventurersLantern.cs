...
{
	public class AdventurersLantern : ModItem
	{
		private int currentActiveEmber = 0;
		
		private readonly int MaxEmberAmount = 10;
		private readonly float MaxActiveDistance = 60;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Adventurer's Lantern");
