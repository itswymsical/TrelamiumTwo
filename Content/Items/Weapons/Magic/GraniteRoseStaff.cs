...
{
    public class GraniteRoseStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Granite Rose Staff");
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<Projectiles.Magic.LightningProjectile>();
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, 
                    ModContent.ProjectileType<Projectiles.Magic.LightningProjectile>(), damage / 2, knockBack, player.whoAmI);
            }
            return true;
        }
